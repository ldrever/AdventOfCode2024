...
public class Day16RoomHistoryPath {
	...
	*/
	...
	public ArrayList<Day16RoomHistoryPath> extend(boolean debug, char c) {
		if(debug) {
		...
		ArrayList<Day16RoomState> headNeighbours = head.getNeighbours(debug, c);
	...
	public ArrayList<Day16RoomHistoryPath> explore(int max, char c) {
			...
			*/
			...
			while(nextGeneration.size() > 0)
			{
				...
				for(Day16RoomHistoryPath path : currentGeneration) {
					ArrayList<Day16RoomHistoryPath> currentChildren = path.extend(false, c);
